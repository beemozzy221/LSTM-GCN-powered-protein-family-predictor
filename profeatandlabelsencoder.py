...
def readyencoding(no_seq, protein_length, uniandpanid, aminochars):
...
if __name__ == "__main__":
    features, unencoded_labels = readyencoding(inputs, size_of_seq, protein_panther_ids_file, amino_char)
